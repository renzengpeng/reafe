...
<div class="col-2 col-auto" style="display:none;">
	...
	<div class="content">
	<?php echo L('main_version')?>Phpcms <?php echo PC_VERSION?>  Release <?php echo PC_RELEASE?> [<a href="http://download.healstec.com/v9/" target="_blank"><?php echo L('main_latest_version')?></a>]<br />
...
<div class="col-2 lf mr10" style="width:48%;display:none;">
	...
	<?php echo L('main_product_site')?><a href="http://www.healstec.com/" target="_blank">http://www.healstec.com/</a> <br />
	<?php echo L('main_product_bbs')?><a href="http://bbs.healstec.com/" target="_blank">http://bbs.healstec.com/</a> <br />
...
<div class="col-2 col-auto" style="display:none;">
	...
	<div class="content">
	<?php echo L('main_version')?>Phpcms <?php echo PC_VERSION?>  Release <?php echo PC_RELEASE?> [<a href="http://buy.healstec.com" target="_blank"><?php echo L('main_support')?></a>]<br />
