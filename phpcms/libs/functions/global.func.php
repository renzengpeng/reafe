 ...
 * @license				http://www.healstec.com/license/
 * @lastmodify			2010-6-1
 */
 ...
 * showmessage('登录成功', array('默认跳转地址'=>'http://www.healstec.com'));
 ...
 * @return 分页
 */
function pages_new($num, $curr_page, $perpage = 20, $urlrule = '', $array = array(),$setpages = 10) {
    if(defined('URLRULE') && $urlrule == '') {
        $urlrule = URLRULE;
        $array = $GLOBALS['URL_ARRAY'];
    } elseif($urlrule == '') {
    ...
    if($num > $perpage) {
        ...
        $multipage .= '';
        if($curr_page>0) {
            $multipage .= ' <li><a href="'.pageurl($urlrule, $curr_page-1, $array).'" class="a1"><span aria-hidden="true">«</span></a></li>';
            if($curr_page==1) {
                $multipage .= ' <li class="active"><a href="#">1</a></li>';
            } elseif($curr_page>6 && $more) {
        ...
        if($curr_page<$pages) {
            if($curr_page<$pages-5 && $more) {
                $multipage .= ' ..<li><a href="'.pageurl($urlrule, $pages, $array).'">'.$pages.'</a></li> <li><a href="'.pageurl($urlrule, $curr_page+1, $array).'" class="a1"><span aria-hidden="true">»</span></a></li>';
            } else {
                $multipage .= ' <li><a href="'.pageurl($urlrule, $pages, $array).'">'.$pages.'</a></li> <li><a href="'.pageurl($urlrule, $curr_page+1, $array).'" class="a1"><span aria-hidden="true">»</span></a></li>';
            }
        } elseif($curr_page==$pages) {
            $multipage .= ' <li  class="active"><a href="#">'.$pages.'</a></li> <li><a href="'.pageurl($urlrule, $curr_page, $array).'" class="a1"><span aria-hidden="true">»</span></a></li>';
        } else {
            $multipage .= ' <li><a href="'.pageurl($urlrule, $pages, $array).'">'.$pages.'</a></li> <li><a href="'.pageurl($urlrule, $curr_page+1, $array).'" class="a1"><span aria-hidden="true">»</span></a></li>';
        }
    }
