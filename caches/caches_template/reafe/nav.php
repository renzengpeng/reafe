            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
                        ...
                        <li <?php if($catid==$r['catid']|| $top_parentid==$r['catid']) { ?>class="active"<?php } ?> ><a href="<?php if($n==1) { ?>/<?php } else { ?><?php echo $r['url'];?><?php } ?>"><?php echo $r['catname'];?> <span class="sr-only">(current)</span></a></li>
                    <?php $n++;}unset($n); ?>
